      ...
      child: Column(
        children: [
          SalesPointItem(
            ...
            image: const Image(
              image: AssetImage(
                  "assets/images/main_platform_info_transparent.png"),
            ),
            tag: "1",
          ),
          const SizedBox(
          ...
          SalesPointItem(
            ...
            image: SvgPicture.asset(
              "assets/icons/main_salespoint_option.svg",
            ),
            tag: "2",
          ),
          const SizedBox(
          ...
          SalesPointItem(
            ...
            subTitle: Text(
              "하나의 플랫폼으로 내담자 정보, 상담 정보를 관리하고 이를 분석하여\n내담자르 체계적으로 관리해 내담자에게 최고의 상담경험을 줄 수 있습니다.",
              style: Theme.of(context).textTheme.subtitle1,
            ),
            image: const Image(
              image: AssetImage("assets/images/main_customer_manage.png"),
            ),
            tag: "3",
          ),
          const SizedBox(
          ...
          SalesPointItem(
            ...
            image: const Image(
              image: AssetImage("assets/images/main_salespoint_quality.png"),
            ),
            tag: "4",
          ),
        ],
